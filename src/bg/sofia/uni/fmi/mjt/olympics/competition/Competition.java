...
public record Competition(String name, String discipline, Set<Competitor> competitors) {
    ...
    public Competition(String name, String discipline, Set<Competitor> competitors) {
        if (name == null || name.isBlank()) {
            throw new IllegalArgumentException("Name of the competition cannot be null or blank");
        }
        if (discipline == null || discipline.isBlank()) {
            throw new IllegalArgumentException("Discipline of the competition cannot be null or blank");
        }
        if (competitors == null || competitors.isEmpty()) {
            throw new IllegalArgumentException("Competitors of the competition cannot be null or empty");
        }
        this.name = name;
